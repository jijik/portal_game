...
#ifndef _WH_AI_XGEN_GRAPH_ASTAR_SEARCH_h__
#define _WH_AI_XGEN_GRAPH_ASTAR_SEARCH_h__
...
#include <XGenAIModule/Navigation/Paths/GraphSearchAStar.inl>

#endif // GraphSearchAStar_h__
