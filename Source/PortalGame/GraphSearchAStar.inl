...
#include <queue>
#include <XGenAIModule/Std/Common.h>
...
// 	template <typename graph_type, typename heuristic_type>
// 	std::list<T_GraphIndex> C_GraphSearchAStar<graph_type, heuristic_type>::GetPath() const
// 	{
// 		std::list<T_GraphIndex> list;
// 
...
// 
// 		while(back != m_startNode && m_SpanningPathTree[back] != 0)
// 		{
// 			back = m_SpanningPathTree[back]->From();
// 			list.push_front(back);
// 		}
// 
// 		return list;
// 	}
	...
	template <typename graph_type, typename heuristic_type>
	void C_GraphSearchAStar<graph_type, heuristic_type>::SetCurrentAgentType(unsigned at)
	{
		// TODO: Clang issue
		//m_currentAgentType = at;
	}

	//=============================================================================================================
// 
// 	template <typename graph_type, typename heuristic_type>
// 	bool C_GraphSearchAStar<graph_type, heuristic_type>::GetPath(std::list<T_GraphIndex> & list) const
// 	{
// 		//list.clear();
// 
// 		if(!m_pathFound || m_dstNode == INVALID_INDEX)
